  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Monthly View</h1>
          <p className="text-sm text-slate-500">Browse totals for any month.</p>
        </div>
        <div className="flex items-center gap-1">
          ...
          <span className="w-36 text-center text-sm font-medium text-slate-900">
      ...
      <Card className="p-5">
        <p className="mb-4 text-sm font-medium text-slate-700">Totals by Category</p>
        {categoryTotals.length === 0 ? (
          <div className="flex flex-col items-center gap-2 py-8 text-center">
            <PieChart className="size-6 text-slate-300" />
            <p className="text-sm text-slate-500">No transactions in {monthLabel(year, month)}.</p>
          </div>
        ) : (
