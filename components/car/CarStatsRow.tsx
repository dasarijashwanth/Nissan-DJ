...
import { CostPerMileCard } from "@/components/car/CostPerMileCard";
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <Card className="p-5">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-500">Total Car Spend</p>
        </div>
      ...
      <CostPerMileCard costPerMile={costPerMile} totalMiles={totalMiles} />
      ...
      <Card className="p-5">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-500">Avg MPG</p>
        </div>
        <p className="mt-4 text-2xl font-semibold tabular-nums text-amber-600">
